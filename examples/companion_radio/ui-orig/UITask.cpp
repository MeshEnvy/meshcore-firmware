...
static const uint8_t meshcore_logo [] PROGMEM = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x1f, 0x1f, 0xe7, 0x79, 0xe3, 0x8f, 0x79, 0xe0, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x19, 0xb3, 0xc9, 0xb3, 0x36, 0xd9, 0xe3, 0x30, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x19, 0xb3, 0xc7, 0xb3, 0x36, 0x19, 0xe3, 0xf0, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x19, 0xb3, 0xcd, 0xb3, 0x36, 0x19, 0xe3, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x19, 0xb3, 0xcd, 0xb3, 0x36, 0xd9, 0xe3, 0x30, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x1f, 0x1e, 0x67, 0x99, 0xe3, 0x8f, 0x61, 0xe0, 0x00, 0x00, 0x00, 0x00,
...
void UITask::renderCurrScreen() {
  ...
  if (_alert[0]) {
    ...
    int logoWidth = 128;
    _display->drawXbm((_display->width() - logoWidth) / 2, 3, potatocore_logo, logoWidth, 13);
    ...
    if (_potato_ingest_needs_config) {
      _display->setTextSize(1);
      _display->setColor(DisplayDriver::YELLOW);
      uint16_t tw = _display->getTextWidth("DM to configure.");
      _display->setCursor((_display->width() - tw) / 2, 56);
      _display->print("DM to configure.");
    }
#endif
  }
  _need_refresh = false;
